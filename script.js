...
const PRODUCTS = [
  ...
  {id: 'p27', name: '🔑 Macramé Keychain Set (3 pcs)', category: 'Macrame,Souvenirs,Accessories', price: 60, rating: 4.6, badge: 'new', image: 'images/27_keychain_set.png', stock: '🔑 Great as giveaways'},
  {id: 'p28', name: '💎 Beaded Bracelet – Crystal Aurora', category: 'Beaded,Accessories', price: 45, oldPrice: 60, rating: 4.7, badge: 'sale', image: 'images/28_bracelet.png', stock: '✨ Hand-strung beads'},
  {id: 'p29', name: '📿 Beaded Anklet – Ocean Wave', category: 'Beaded,Accessories', price: 55, rating: 4.5, image: 'images/29_anklet.png', stock: '🌊 Summer essential'},
  {id: 'p30', name: '🦋 Beaded Lanyard – Boho Feather', category: 'Beaded,Accessories,Souvenirs', price: 75, rating: 4.8, badge: 'best', image: 'images/30_lanyard.png', stock: '🪶 Unique & stylish'},
  {id: 'p31', name: '🧵 Crochet Coaster Set – Sunflower (6pcs)', category: 'Crochet,Home Decor', price: 130, oldPrice: 160, rating: 4.9, badge: 'sale', image: 'images/31_coasters.png', stock: '🌻 Brighten any table'},
